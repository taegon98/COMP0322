...
public class FiftService {
    ...
    public static void start_Service(Connection conn, Statement stmt) throws SQLException {
        ...
        while(true) {
            ...
            System.out.println("1) 해당하는 사이즈 보다 크거나 같은 사이즈를 같은 회원 수 반환");
            System.out.println("2) 구매한 금액을 입력 받고 해당 금액보다 같거나 큰 회원 정보 반환");
            System.out.println("3) 비밀번호 변경");
            System.out.println("4) 신체 사이즈 업데이트");
            System.out.println("5) 금액을 입력받고 해당 금액보다 큰 물품 반환");
            System.out.println("6) 물품 이름의 일부를 입력 받고 해당 글자가 포함된 물품 반환");
            System.out.println("7) 주문일이 특정 시점 사이에 있는 오더 디테일 검색");
            System.out.println("8) 금액을 입력 받고 Order_Detail에서 총 구매액이 입력 금액 보다 큰 값 반환");
            System.out.println("9) 티어 입력 할인율");
            System.out.println("10) 특정 티어 이상의 회원 찾기");
